...
% Расчет теоретического RSRP в логарифмической шкале через ширину полосы
function rsrp = theoretical_RSRP(D, Txpower, antGain, feedet, BW, rsrp_freq)
    ...
    % Вычисляем мощность в логарифмической шкале через ширину полосы
    power = Txpower + antGain - PL - feedet + 10*log10(BW) - 10*log10(rsrp_freq);
    % Переход от мощности в логарифмическую шкалу для RSRP
    rsrp = power;
end
...
% Расчет RSRP для точек с использованием ширины полосы
...
% Теоретический расчет RSRP через ширину полосы
